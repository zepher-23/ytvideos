...
export const GreyCloud = ({ x = 6280, y = 300, scale = 1.05 }) => {
  return (
    <g
      id="heavy-grey-cloud"
    ...
    >
      ...
      {/* Heavy Grey Cloud Body (Dense, looming comic cloud puffs) */}
      ...
      {/* Comic Gloom Hatching lines on underside */}
      ...
      {/* Persistent Gloom Rain Droplets / Drizzle hanging stubbornly over stickman */}
