...
/**
 * Calendar - Wall Hanging Calendar with Natural Sway and Date Circling VFX
 */
export const Calendar = ({
  ...
  // Hand-drawn red circle animation circling the date
  const circleProgress = interpolate(frame, [circleStartFrame, circleEndFrame], [0, 1], {
  ...
  return (
    ...
    >
      {/* Wall Pin / Nail */}
      <circle cx="210" cy="20" r="9" fill="#000000" stroke="#000000" strokeWidth="3" />
      <circle cx="208" cy="18" r="3" fill="#FFFFFF" />

      {/* Hanging Strings */}
      <line x1="210" y1="20" x2="90" y2="80" stroke="#000000" strokeWidth="5" strokeLinecap="round" />
      <line x1="210" y1="20" x2="330" y2="80" stroke="#000000" strokeWidth="5" strokeLinecap="round" />

      {/* Calendar Hard Comic Drop Shadow */}
      <rect x="36" y="88" width="360" height="430" rx="18" fill="#000000" opacity="0.2" />
      ...
      <line x1="45" y1="198" x2="375" y2="198" stroke="#000000" strokeWidth="4" strokeLinecap="round" />
      ...
      {/* Folded Paper Bottom Corner */}
      <path d="M 350 510 L 390 470 L 350 470 Z" fill="#E5E7EB" stroke="#000000" strokeWidth="5" strokeLinejoin="round" />
      <line x1="350" y1="510" x2="390" y2="470" stroke="#000000" strokeWidth="5" strokeLinecap="round" />
    </g>
  );
};
